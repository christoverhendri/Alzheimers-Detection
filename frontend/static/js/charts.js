...
document.addEventListener("DOMContentLoaded", () => {
    ...
    (async function loadAll() {
        try {
            // ---- SUMMARY ----
            const summary = await fetchJson("http://10.16.162.224:5000/api/summary");
            ...
            // ---- DIAGNOSIS COUNT ----
            const diag = await fetchJson("http://10.16.162.224:5000/api/diagnosis_counts");
            elegantBar(
            ...
            // ---- AGE ----
            const age = await fetchJson("http://10.16.162.224:5000/api/age_distribution");
            elegantBar(
            ...
            // ---- BMI ----
            const bmi = await fetchJson("http://10.16.162.224:5000/api/bmi_stats");
            ...
            // ---- EDUCATION ----
            const edu = await fetchJson("http://10.16.162.224:5000/api/education_vs_diagnosis");
            ...
            // ---- SMOKING ----
            try {
                const smoke = await fetchJson("http://10.16.162.224:5000/api/smoking_by_diag");
            ...
            // ---- ALCOHOL ----
            try {
                const alc = await fetchJson("http://10.16.162.224:5000/api/alcohol_stats");
            ...
            // ---- ACTIVITY ----
            try {
                const act = await fetchJson("http://10.16.162.224:5000/api/activity_by_diag");
            ...
            // ---- COGNITIVE ----
            const cognitive = await fetchJson("http://10.16.162.224:5000/api/cognitive_stats");
            ...
            // ---- RADAR ----
            const radar = await fetchJson("http://10.16.162.224:5000/api/radar_data");
            elegantRadar(
            ...
            const corr = await fetchJson("http://10.16.162.224:5000/api/correlation_diagnosis");
